...
const LICENSE_TYPES = [
  {
    ...
    bg: "bg-green-ink/5",
    desc: "Attribution only. Free for any use.",
  },
  {
    id: "sello-nc",
    label: "Sello NC",
    ...
    bg: "bg-gold/5",
    desc: "Free for humans. Companies pay.",
  },
  {
    id: "sello-voice",
    label: "Sello Voice",
    ...
    bg: "bg-primary/5",
    desc: "Read free. Narration via micropayment.",
  },
  {
    id: "sello-pay",
    label: "Sello Pay",
    ...
    bg: "bg-orange-400/5",
    desc: "All AI use requires payment.",
  },
  {
    id: "sello-no-train",
    label: "No Train",
    ...
    bg: "bg-red-400/5",
    desc: "Use allowed. Training prohibited.",
  },
];
        ...
        <div className="relative z-10 space-y-6">
          <div className="space-y-3">
            ...
            <h1 className="font-headline text-5xl font-black uppercase leading-[0.9] tracking-tight text-cream sm:text-6xl lg:text-7xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
              Your Content.
              <br />
              <span className="text-primary underline decoration-primary/20 decoration-4 underline-offset-4 italic">
                Your Terms.
              </span>
              <br />
          ...
          <div className="flex flex-col gap-3 sm:flex-row animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
            <Link
              href="/register"
              className="stamp-button text-xl px-10 py-4 group"
            >
              I'm a Creator
              <svg
            ...
            <Link
              ...
              className="stamp-button stamp-button-secondary text-xl px-10 py-4"
            >
              I'm an AI Developer
            </Link>
          </div>
          ...
          <div className="postal-card relative rotate-[-1.5deg] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.9)] border-primary/25">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="overflow-x-auto bg-background border border-border-low p-3 font-mono text-[9px] leading-relaxed text-muted/80">
                ...
                <br />
                <span className="pl-3 text-cream/70">
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          <div className="mb-14 text-center space-y-3">
            ...
            <p className="text-muted text-base max-w-xl mx-auto">
              From article to AI payment in three steps. No SDK, no API key, no
              agreement. Just a tag in your HTML.
            </p>
          </div>
          ...
          <div className="grid gap-0 md:grid-cols-3">
            {HOW_IT_WORKS.map((item, i) => (
              <div
                key={item.step}
                className={`relative p-8 md:p-10 space-y-5 ${i < 2 ? "md:border-r border-border-low" : ""} ${i > 0 ? "border-t md:border-t-0 border-border-low" : ""}`}
              >
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={text} className="flex gap-4 items-start">
                    <span className="font-display text-primary text-lg mt-0.5 shrink-0">
                      {icon}
                    </span>
            ...
            <div className="bg-card/30 p-10 md:p-14 space-y-8">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  {
                    icon: "◈",
                    text: "Sello Skill works in Claude Code, Codex, Gemini CLI out of the box.",
                  },
                  {
                    icon: "§",
                    text: "Cross-chain: arrive with USDC from any chain via LI.FI bridge.",
                  },
                ].map(({ icon, text }) => (
                  <li key={text} className="flex gap-4 items-start">
                    <span className="font-display text-gold text-lg mt-0.5 shrink-0">
                      {icon}
                    </span>
                    <p className="text-sm text-muted leading-relaxed">{text}</p>
                  </li>
              ...
              <Link
                href="/onboarding/agent"
                className="stamp-button-secondary inline-flex px-8 py-4 group border border-gold text-gold hover:bg-gold hover:text-background"
              >
                Setup My Agent
                <svg
                  className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1"
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <p className="text-muted text-sm max-w-xs leading-relaxed">
              Like Creative Commons, but for AI agents. Machine-readable,
              on-chain verifiable, micropayment-enabled.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {LICENSE_TYPES.map((l) => (
              <div
                key={l.id}
                className={`postal-card ${l.border} ${l.bg} p-6 space-y-3 group hover:scale-[1.02] transition-transform duration-300`}
              >
                <p
                  className={`font-display text-xl uppercase tracking-widest ${l.color}`}
                >
                  {l.label}
                </p>
          ...
          <div className="postal-card p-8 md:p-14 space-y-8 border-primary/20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted">
                  Asilo Digital — 2,700+ articles shielded with one line of
                  HTML.
                </p>
              </div>
            ...
            <div className="bg-background border border-primary/20 relative group">
              ...
              <div className="p-6 font-mono text-[11px] md:text-sm leading-relaxed text-muted overflow-x-auto">
                ...
                <br />
                <span className="pl-4 text-green-ink">id:8xK2mN</span>
                <span className="text-muted/40">|</span>
                <span className="text-primary">license:sello-voice</span>
                <span className="text-muted/40">|</span>
                <br />
                <span className="pl-4 text-cream">author:Daniel Patete</span>
                <span className="text-muted/40">|</span>
                <span className="text-cream">publisher:Asilo Digital</span>
                <span className="text-muted/40">|</span>
                <br />
                ...
                <span className="pl-4 text-muted">
                  onchain:solana:devnet:2NDZJtmAN44AMtTUBDd56zR2so...
                </span>
                <span className="text-muted/40">|</span>
                <br />
            ...
            <div className="grid gap-6 sm:grid-cols-3 text-center border-t border-border-low pt-8">
              {[
                {
                  label: "AI reads article",
                  sub: "Parses meta tag",
                  icon: "👁",
                },
                { label: "Pays $0.10 USDC", sub: "x402 automatic", icon: "⚡" },
                {
                  label: "Receipt on Solana",
                  sub: "Immutable proof",
                  icon: "◈",
                },
              ].map(({ label, sub, icon }) => (
      ...
      <section className="border-t border-border-low bg-card/20 py-20 md:py-28">
        <div className="mx-auto max-w-4xl px-6 text-center space-y-10">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              href="/register"
              className="stamp-button px-12 py-4 text-xl group"
            >
              Creator Onboarding
              <svg
                className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1"
            ...
            <Link
              href="/onboarding/agent"
              className="stamp-button stamp-button-secondary px-12 py-4 text-xl"
            >
              AI Developer Tools
            </Link>
          </div>
